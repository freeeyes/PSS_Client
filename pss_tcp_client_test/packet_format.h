...
public:
    ...
    bool format_recv_buffer(int connect_id, const char* recv_buffer, size_t buffer_length) final;

    std::string format_send_buffer(int connect_id, short command_id, std::string recv_buffer, size_t buffer_length) final;
